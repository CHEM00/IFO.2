        ...
        <main>
            <form action="<?php echo e(route('Inicio')); ?>" method="GET">
                <div class="Container_img">
                    <img src=" <?php echo e(asset ('imgs/LogoIntekel.png')); ?>" alt="">
                </div>
                ...
                <div class="Div_LabelRegistro">
                    <p id="P_NoCuenta">¿No tienes cuenta? </p> <a href="<?php echo e(route ('Registre')); ?>" id="A_Registro">Regístrate</a></p>
            </form>
        </main>
    </body>
</html>
<?php /**PATH C:\Users\18Z99LA\Desktop\Intekel_Financer2.0\IFO.2\IntekelFinancer\resources\views/Login.blade.php ENDPATH**/ ?>