...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <main>
        <div class="w-full max-w-screen-xl p-4">
            <div class="w-full h-14 rounded-t-lg flex items-center justify-between px-4" style="background-color:#4E9E19 ">
                <strong class="text-white text-2xl font-semibold">
                    Registro
                </strong>
                <a href="{{route ('Login')}}">
            ...
            <div class="bg-white shadow-md p-6">
                ...
                <form action="{{route ('register')}}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <button type="submit" class="w-full text-white py-2 px-4 rounded-md " style="background-color: #4E9E19">Registrarse</button>
                    </div>
                </form>
            </div>
        </div>
