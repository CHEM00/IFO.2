        ...
        @endif
                    <form action="{{route ('Login')}}" method="POST" class="p-8 w-full max-w-lg transition duration-500 ease-in-out">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="email" name = "email" class="form-control w-full mt-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" id="Input_Email" placeholder="Ejemplo@correo.com" required>
                        </div>
                        <div class="mb-4">
                            <label for="Input_Password" class="block text-gray-900 font-semibold text-lg">Contraseña</label>
                            <input type="password" name="password" class="form-control w-full mt-1 p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" id="Input_Password" placeholder="********" required>
                        </div>
