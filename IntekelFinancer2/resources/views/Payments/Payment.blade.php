        ...
        <div class="overflow-x-auto p-2 ">
            <div class="bg-emerald-900 relative shadow-md sm:rounded-small overflow-hidden" id="div_header">
                <div
                    ...
                    <div>
                        <Strong class="text-white font-mono text-xl">Lista de pagos</Strong>
                    </div>
                    <div
                    ...
                    <table class="min-w-full text-sm text-left text-dark">
                        <thead class="text-xs uppercase bg-gray-50 dark:bg-gray-700 dark:text-white">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3">Fecha de timbrado</th>
                                <th scope="col" class="px-6 py-3">Cliente</th>
                                <th scope="col" class="px-6 py-3">Tiempo de retardo</th>
                                <th scope="col" class="px-6 py-3">Monto pagado</th>
                                <th scope="col" class="px-6 py-3">Monto en adeudo</th>
